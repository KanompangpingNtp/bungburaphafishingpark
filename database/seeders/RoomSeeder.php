...
class RoomSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            ['room_type_id' => 1, 'room_name' => 'No.6 Ban PlaWen', 'room_status' => '1'],
            ['room_type_id' => 2, 'room_name' => 'No.5 Ban PlaChalam', 'room_status' => '2'],
            ['room_type_id' => 2, 'room_name' => 'No.20 Ban Pla MorTale', 'room_status' => '2'],

            ['room_type_id' => 3, 'room_name' => 'No.13 Ban Pla Ronan', 'room_status' => '3'],
            ['room_type_id' => 3, 'room_name' => 'No.14 Ban Pla Kraben', 'room_status' => '3'],

            ['room_type_id' => 4, 'room_name' => 'No.3 Ban Pla ChomNgam', 'room_status' => '4'],
            ['room_type_id' => 4, 'room_name' => 'No.4 Ban Pla InSea', 'room_status' => '4'],
            ['room_type_id' => 4, 'room_name' => 'No.19 Ban PlaSingTo', 'room_status' => '4'],
            ['room_type_id' => 4, 'room_name' => 'No.21 Ban Pla KraThongRom', 'room_status' => '4'],

            ['room_type_id' => 5, 'room_name' => 'No.1 Ban Pla Sak', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.2 Ban Pla Kea', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.7 Ban Pla Tu', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.10 Ban Pla PukPao', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.11 Ban Pla Gramongdang', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.12 Ban Pla-O', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.15 Ban KuLao', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.16 Ban PlaJamed', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.17 Ban PlaSaLa', 'room_status' => '5'],
            ['room_type_id' => 5, 'room_name' => 'No.18 Ban PlaAngGrey', 'room_status' => '5'],

            ['room_type_id' => 5, 'room_name' => 'No.8 Ban PlaCartoon', 'room_status' => '6'],
            ['room_type_id' => 5, 'room_name' => 'No.9 Ban PlaSingTo', 'room_status' => '6'],
        ];
